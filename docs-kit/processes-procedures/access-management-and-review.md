...
Covers granting, removing, and periodically reviewing system access — standard and privileged. Endpoint (laptop) admin rights specifically are covered separately by [Endpoint Privileged Access Management](endpoint-privileged-access-management.md); this procedure is about access to *systems*.
...
**Frameworks referenced**: ISO/IEC 27001 Annex A's access-control objectives; NIST's access-control guidance (SP 800-53 family) if you operate in or alongside a US government context.
