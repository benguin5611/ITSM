...
[`references/build-loop.md`](references/build-loop.md). Commit-message form, atomicity, and the
two-tier squash model: [`references/commit-conventions.md`](references/commit-conventions.md).
